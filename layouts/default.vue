...
export default {
  ...
  mounted() {
    if (process.client) {
      ...
      // Dhruv (admin)
      let cookie =
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..7NKaoTwlgkwho6DzjV96ohKvQznbASt846ZA1KRCtN0";
