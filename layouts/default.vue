...
export default {
  ...
  mounted() {
    ...
    if(!this.isAdmin) {
      ...
      // Charan
      // let cookie = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..3GlavEBOTcxMq7UqdwiPy0bbTpLLw6WBVUeemfSQF6s"
