  ...
  <div id="projects-wrapper" class="projects-wrapper" >   
    ...
    <div id="projects-list-wrapper" class="projects-list-wrapper position-relative" >
      ...
      <template v-if="projects.length">
        ...
        <adv-table-two :tableFields="tableFields" :tableData="localData" :contextItems="projectContextItems" @context-item-event="contextItemClick" @row-click="projectRoute" @title-click="projectRoute" @table-sort="sortProject"  @update-field="updateProject" :isProject="true" @create-row="createProject"></adv-table-two>
        </div>
       <div v-else>
        <loading :loading="loading"></loading>
