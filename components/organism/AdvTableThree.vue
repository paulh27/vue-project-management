...
export default {
  ...
  methods: {
    ...
    handleScroll(event) {
      ...
      const scrollThreshold = tableContainer.scrollHeight * 0.6; // 60% of the scroll height
      const isAtBottom = tableContainer.scrollTop + tableContainer.clientHeight + 5 >= scrollThreshold;
