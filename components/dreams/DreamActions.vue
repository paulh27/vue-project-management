<template>
  <div id="dream-action-wrapper" class="task-actions ml-05">
    ...
    <div class="action-right" id="da-action-right">
      <ul class="actions" id="da-actions-list">
        <li class="action" id="da-action-item1">
          <sorting-comp label="Viewing" :items="viewing" icon="eye-open" v-on:change-sort="viewDreams($event)"></sorting-comp>
        </li>
        
        <li class="action" id="da-action-item3">
...
<script>
import { DREAM_VIEW_FILTER, DREAM_SORT } from 'config/constants.js'
